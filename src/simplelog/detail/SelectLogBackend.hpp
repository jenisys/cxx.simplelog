...
#  elif SIMPLELOG_USE_BACKEND_QUILL
#   define SIMPLELOG_BACKEND_MACROS_HEADER_FILE "simplelog/backend/quill/LogBackendMacros.hpp"
#   define SIMPLELOG_USE_BACKEND 4
#  else
