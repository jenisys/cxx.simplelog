...
#        define SIMPLELOG_BACKEND_MACROS_HEADER_FILE                           \
            "simplelog/backend/syslog/LogBackendMacros.hpp"
#        define SIMPLELOG_USE_BACKEND 2
#    elif SIMPLELOG_USE_BACKEND_SYSTEMD_JOURNAL
#        define SIMPLELOG_BACKEND_MACROS_HEADER_FILE                           \
            "simplelog/backend/systemd_journal/LogBackendMacros.hpp"
#        define SIMPLELOG_USE_BACKEND 3
#    else
#        define SIMPLELOG_BACKEND_MACROS_HEADER_FILE                           \
            SIMPLELOG_DEFAULT_BACKEND_MACROS_HEADER_FILE
...
#ifndef SIMPLELOG_BACKEND_MACROS_HEADER_FILE
#    error                                                                     \
        "CONFIG-ERROR in SelectLogBackend: SIMPLELOG_BACKEND_MACROS_HEADER_FILE is UNDEFINED."
#endif
