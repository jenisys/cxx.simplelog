...
#define SIMPLELOG_FATAL0_IF(condition, message)                                                                           \
    SIMPLELOG_BACKEND_LOG_IF(condition, simplelog_defaultModule, SIMPLELOG_BACKEND_LEVEL_FATAL, message)
#define SIMPLELOG_CRITICAL0_IF(condition, message)                                                                        \
    SIMPLELOG_BACKEND_LOG_IF(condition, simplelog_defaultModule, SIMPLELOG_BACKEND_LEVEL_CRITICAL, message)
#define SIMPLELOG_ERROR0_IF(condition, message)                                                                           \
    SIMPLELOG_BACKEND_LOG_IF(condition, simplelog_defaultModule, SIMPLELOG_BACKEND_LEVEL_ERROR, message)
...
#define SIMPLELOG_DEBUG0_IF(condition, message)                                                                           \
    SIMPLELOG_BACKEND_LOG_IF(condition, simplelog_defaultModule, SIMPLELOG_BACKEND_LEVEL_DEBUG, message)
