 ...
 *log-macros) SIMPLELOG_DEFINE_DEFAULT_MODULE("foo.default"); STRACE_WARN("Hello
 *Alice"); STRACE_ERROR("Hello {0} and {1}", "Alice", "Bob"); //< With params
 *  }
 *
...
// SIMPLELOG_BACKEND_DEFINE_MODULE(var_name, name) #define
// SIMPLELOG_DEFINE_STATIC_MODULE(var_name, name)
// SIMPLELOG_BACKEND_DEFINE_STATIC_MODULE(var_name, name) #define
// SIMPLELOG_DEFINE_DEFAULT_MODULE(name)
// SIMPLELOG_BACKEND_DEFINE_MODULE(simplelog_defaultModule, name) #define
// SIMPLELOG_DEFINE_STATIC_DEFAULT_MODULE(name)
...
// --------------------------------------------------------------------------
// SHORTER TRACE MACROS: STRACE_xxx() = SIMPLELOG_TRACE_xxx(), STRACEM_xxx() =
// SIMPLELOGM_TRACE_xxx()
// --------------------------------------------------------------------------
