...
# MAY CAUSE: CMake Error if CMAKE_GENERATOR does not support it (Ninja, ...)
if(NOT DEFINED CMAKE_DEFAULT_BUILD_TYPE)
    if(DEFINED CMAKE_CONFIGURATION_TYPES)
        ...
        message(STATUS "USE: CMAKE_DEFAULT_BUILD_TYPE=${_CMAKE_DEFAULT_BUILD_TYPE} (from CMAKE_CONFIGURATION_TYPES=${CMAKE_CONFIGURATION_TYPES})")
    else()
...
if(NOT DEFINED CMAKE_BUILD_TYPE)
    set(CMAKE_BUILD_TYPE "${_CMAKE_DEFAULT_BUILD_TYPE}" CACHE STRING "CMake build type: Debug, Release, ...")
endif()
...
# ENDIF()
message(STATUS "USING: CMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} (CTEST_CONFIGURATION_TYPE=${CTEST_CONFIGURATION_TYPE})")

if(CODE_COVERAGE OR CMAKE_BUILD_TYPE STREQUAL "Coverage" OR CMAKE_BUILD_TYPE STREQUAL "coverage")
